...
const Feature = () => {
    ...
    const features: Feature[] = [
        ...
        },
        {
            ...
            description: "In metus vulputate eu scelerisque felis imperdiet. Nunc scelerisque viverra mauris in aliquam sem.",
            image: Img3,
            arrow: Arrow,
        },
    ];
                ...
                <div className={FeatureStyle.features}>
                    {features.map((feature) => (
                        <div
                            ...
                            className={`${FeatureStyle.featureCard} ${activeFeatureIndex === feature.index ? 'featureCardClicked' : FeatureStyle.active
                                }`}
                        >
                            <div className={FeatureStyle.featureslist}><label className={FeatureStyle.featureDropdown}>{feature.title}</label>
                                <img
                                    src={feature.arrow}
                                    alt="Dropdown arrow"
                                    className={`${activeFeatureIndex === feature.index ? FeatureStyle.arrowRotated : ''}`}
                                />
                            ...
                            {activeFeatureIndex === feature.index && (
                                <>
                                    <div className={FeatureStyle.dropdownContent}>
                                        <div className={FeatureStyle.featureImg}><img
